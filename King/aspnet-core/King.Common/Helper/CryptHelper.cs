...
namespace King.Common.Helper
{
    ...
    public class CryptHelper
    {
        ...
        public static string EncryptSha1New(string strContent)
        {
        ...
        /// <param name="strContent"></param>
        /// <returns>返回32位16进制数字字母，若要获取16位需要从32位中取16位</returns>
        public static string EncryptMd5New(string strContent)
        {
        ...
        public static string UrlDecode(string strValue, bool bComplex = false)
        {
            ...
            return System.Net.WebUtility.UrlDecode(strValue);
        }
        ...
        public static string UrlEncode(string strValue, bool bComplex = false)
        {
            ...
            return System.Net.WebUtility.UrlEncode(strValue);
        }
